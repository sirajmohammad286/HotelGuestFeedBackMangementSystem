...
<div class="wrapper">
  ...
  <div class="menu">
    <ul>
      ...
      <li><a href="student.jsp" class="active">Guest</a></li>
...
%>
    <div class="header-button"><a href="#">Guest Registration</a> </div>
    <br>
  </div>
  <center>
      
           <form name="myform" action="guestregact.jsp" method="post" >
           <table border="0" >
